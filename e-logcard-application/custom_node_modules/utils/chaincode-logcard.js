...
// Parts 
	...
	exports.scrapp=function(user, id, vDate) {
		return Util.invokeChaincode(user, 'scrapp', [ id, vDate ]);
	};
...
// Aircrafts 
	...
	exports.Replace=function(user,id, idpart, idpart1) {
		// generer un UIId
		return Util.invokeChaincode(user, 'Replace', [id, idpart, idpart1]);
	};
	exports.AddAssemblyToAc=function(user,id, idassembly) {
		// generer un UIId
		return Util.invokeChaincode(user, 'AddAssemblyToAc', [id, idassembly]);
	};
	exports.RemoveAssemblyFromAc=function(user,id, idassembly) {
		// generer un UIId
		return Util.invokeChaincode(user, 'RemoveAssemblyFromAc', [id, idassembly]);
	};
