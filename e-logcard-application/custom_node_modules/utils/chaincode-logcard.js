...
// Invoke	
	exports.createAssembly=function(user,assembly) {
		// generer un UIId
		return Util.invokeChaincode(user, 'createAssembly', [assembly.an, assembly.sn, assembly.id, assembly.assemblyName, assembly.owner, assembly.vDate ]);
	};
...
// Invoke 
	exports.createAircraft=function(user,aircraft) {
		// generer un UIId
		return Util.invokeChaincode(user, 'createAircraft', [aircraft.an, aircraft.sn, aircraft.id, aircraft.aircraftName, aircraft.owner, aircraft.vDate ]);
	};
