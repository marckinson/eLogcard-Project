...
router.put("/parts/:action", function (req, res, next) {
	enrollUser(req,function(enrolledUser){
...
router.get("/parts/historic", function (req, res, next) {
	enrollUser(req,function(enrolledUser){
		var id = req.query.id;
...
router.get("/aircrafts/historic", function (req, res, next) {
	enrollUser(req,function(enrolledUser){
		var id = req.query.id;
...
router.get("/aircrafts/listing", function (req, res, next) {
	enrollUser(req,function(enrolledUser){
		var id = req.query.id;
...
router.put("/aircrafts/transfer", function (req, res, next) {
	enrollUser(req,function(enrolledUser){
...
router.put("/aircrafts/add", function (req, res, next) {
	enrollUser(req,function(enrolledUser){
		var id = req.body.id;
		var idpart = req.body.idpart;
...
router.get("/assemblies/historic", function (req, res, next) {
	enrollUser(req,function(enrolledUser){
		var id = req.query.id;
...
router.get("/assemblies/listing", function (req, res, next) {
	enrollUser(req,function(enrolledUser){
		var id = req.query.id;
