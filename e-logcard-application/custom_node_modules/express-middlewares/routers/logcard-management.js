...
router.put("/parts/scrapp/", function (req, res, next) {
	enrollUser(req,function(enrolledUser){
		var vDate = format.asString("yyyy/MM/dd hh:mm:ss", new Date());
		var id = req.body.id;
        let parts = logcardManager.scrapp(enrolledUser, id, vDate).then(function (parts) {
...
router.get("/aircrafts/listing/:id", function (req, res, next) {
	enrollUser(req,function(enrolledUser){
		var id = req.query.id;
...
router.put("/aircrafts/remove", function (req, res, next) {
	enrollUser(req,function(enrolledUser){
		var id = req.body.id;
		var idpart = req.body.idpart;
		logcardManager.RemovePartFromAc(enrolledUser, id, idpart).then(function () {
...
router.put("/aircrafts/transfer/:id", function (req, res, next) {
	enrollUser(req,function(enrolledUser){
		...
		var id = req.params.id
		logcardManager.AcOwnershipTransfer(enrolledUser, id, owner).then(function () {
		console.log("Ownership Transfer succeed");
		res.status("200").send(true);
		});
	});
});
router.put("/aircrafts/add/part", function (req, res, next) {
	enrollUser(req,function(enrolledUser){
		var id = req.body.id;
		var idpart = req.body.idpart;
		logcardManager.addPartToAc(enrolledUser, id, idpart).then(function () {
...
router.put("/aircrafts/replace/part", function (req, res, next) {
	enrollUser(req,function(enrolledUser){
		var id = req.body.id;
		var idpart = req.body.idpart;
		var idpart1 = req.body.idpart1;

		logcardManager.Replace(enrolledUser, id, idpart, idpart1 ).then(function () {
            console.log("Part removed with success");
            res.status("200").send(true);
        });
	});
});
router.put("/aircrafts/add/assembly", function (req, res, next) {
	enrollUser(req,function(enrolledUser){
		var id = req.body.id;
		var idassembly = req.body.idassembly;
		logcardManager.AddAssemblyToAc(enrolledUser, id, idassembly).then(function () {
            console.log("Part added with success");
            res.status("200").send(true);
        });
	});
...
router.put("/aircrafts/remove/assembly", function (req, res, next) {
	enrollUser(req,function(enrolledUser){
		var id = req.body.id;
		var idassembly = req.body.idassembly;
		logcardManager.RemoveAssemblyFromAc(enrolledUser, id, idassembly).then(function () {
            console.log("Part added with success");
            res.status("200").send(true);
        });
	});
...
router.post("/assemblies", function (req, res, next) {
	...
	enrollUser(req,function(enrolledUser){
		logcardManager.createAssembly(enrolledUser, aircraft).then(function () {
...
router.get("/assemblies/listing/:id", function (req, res, next) {
	enrollUser(req,function(enrolledUser){
		var id = req.params.id;
...
router.put("/assemblies/remove", function (req, res, next) {
	enrollUser(req,function(enrolledUser){
		var id = req.body.id;
		var idpart = req.body.idpart;
		logcardManager.RemovePartFromAs(enrolledUser, id, idpart).then(function () {
            console.log("Part removed with success");
            res.status("200").send(true);
        });
	});
});
router.put("/assemblies/transfer", function (req, res, next) {
	enrollUser(req,function(enrolledUser){
		var owner = req.body.owner;
		var id = req.query.id
		logcardManager.AssembOwnershipTransfer(enrolledUser, id, owner).then(function () {
		console.log("Ownership Transfer succeed");
		res.status("200").send(true);
		});
	});
});
router.put("/assemblies/add", function (req, res, next) {
	enrollUser(req,function(enrolledUser){
		var id = req.body.id;
		var idpart = req.body.idpart;
		logcardManager.addPartToAssemb(enrolledUser, id, idpart).then(function () {
            console.log("Part added with success");
            res.status("200").send(true);
        });
	});
